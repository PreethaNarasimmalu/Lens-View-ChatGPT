    ...
    <>
      ...
      >
        ...
        <div className="flex items-center justify-between px-3 pt-3 pb-2">
          <button
            aria-label="New chat"
            className="flex items-center gap-2 px-3 py-2 rounded-lg text-sm text-gray-200 hover:bg-white/5 transition-colors w-full"
          >
            {/* ChatGPT logo mark */}
          ...
          <button
            aria-label="New chat"
            className="flex items-center justify-center w-8 h-8 rounded-lg text-gray-400 hover:text-gray-200 hover:bg-white/5 transition-colors shrink-0"
          >
        ...
        <div className="px-3 pb-2">
          <button className="flex items-center gap-2 w-full px-3 py-2 rounded-lg text-sm text-gray-400 hover:bg-white/5 transition-colors">
        ...
        <nav className="flex-1 overflow-y-auto px-3 pb-4 space-y-4">
          {DATE_GROUPS.map(([label, chats]) => (
            <div key={label}>
              <p className="px-3 py-1 text-xs font-medium text-gray-500 uppercase tracking-wider">{label}</p>
        ...
        <div className="border-t border-white/5 px-3 py-3 space-y-1">
          <ThemeToggle />
          <button className="flex items-center gap-3 w-full px-3 py-2 rounded-lg text-sm text-gray-300 hover:bg-white/5 hover:text-white transition-colors">
